...
var _BulkDeleteButton = require('../button/BulkDeleteButton');

var _BulkDeleteButton2 = _interopRequireDefault(_BulkDeleteButton);

var _BulkActionsToolbar = require('./BulkActionsToolbar');

var _BulkActionsToolbar2 = _interopRequireDefault(_BulkActionsToolbar);
...
var ListView = function ListView(_ref2) {
    var _ref2$actions = _ref2.actions,
        ...
        bulkActionButtons = _ref2$bulkActionButto === undefined ? _react2.default.createElement(_BulkDeleteButton2.default, null) : _ref2$bulkActionButto,
        ...
        title = _ref2.title,
        rest = (0, _objectWithoutProperties3.default)(_ref2, ['actions', 'filters', 'bulkActions', 'bulkActionButtons', 'pagination', 'children', 'className', 'classes', 'exporter', 'title']);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_Title2.default, { title: title, defaultTitle: defaultTitle }),
        _react2.default.createElement(
            _Card2.default,
            { className: classes.card },
            bulkActions !== false && bulkActionButtons !== false && bulkActionButtons && !bulkActions && _react2.default.createElement(
                _BulkActionsToolbar2.default,
                controllerProps,
                bulkActionButtons
            ),
            (filters || actions) && _react2.default.createElement(_ListToolbar2.default, (0, _extends3.default)({
                filters: filters
            }, controllerProps, {
                actions: actions,
...
ListView.propTypes = {
    ...
    bulkActionButtons: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.element]),
...
List.propTypes = {
    ...
    bulkActionButtons: _propTypes2.default.oneOfType([_propTypes2.default.element, _propTypes2.default.bool]),
