...
export default (function (db) {
    ...
    return db.categories.reduce(function (acc, category) {
        return [].concat(_toConsumableArray(acc), _toConsumableArray(Array.from(Array(10).keys()).map(function (index) {
            ...
            return {
                ...
                reference: category.name.substr(0, 2) + '-' + random.alphaNumeric(5) + '-' + random.arrayElement('ABCDEFGHIJKLMNOPQRSTUVWXYZ'),
                width: width,
                height: height,
