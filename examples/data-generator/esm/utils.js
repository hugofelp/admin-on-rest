...
export var weightedArrayElement = function weightedArrayElement(values, weights) {
...
export var weightedBoolean = function weightedBoolean(likelyhood) {
    return faker.random.number(99) < likelyhood;
};

export var randomDate = function randomDate(minDate, maxDate) {
...
export var randomFloat = function randomFloat(min, max) {
