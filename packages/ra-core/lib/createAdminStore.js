...
var _formMiddleware = require('./form/formMiddleware');

var _formMiddleware2 = _interopRequireDefault(_formMiddleware);
...
exports.default = function (_ref) {
    ...
    var store = (0, _redux.createStore)(resettableAppReducer, initialState, (0, _redux.compose)((0, _redux.applyMiddleware)(sagaMiddleware, _formMiddleware2.default, (0, _reactRouterRedux.routerMiddleware)(history)), typeof window !== 'undefined' && window.devToolsExtension ? window.devToolsExtension() : function (f) {
        return f;
    }));
