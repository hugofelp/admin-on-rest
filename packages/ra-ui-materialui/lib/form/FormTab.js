    ...
    function FormTab() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = FormTab.__proto__ || Object.getPrototypeOf(FormTab)).call.apply(_ref2, [this].concat(args))), _this), _this.renderHeader = function (_ref3) {
            ...
            var children = _ref4.children,
                rest = (0, _objectWithoutProperties3.default)(_ref4, ['children']);
            ...
            return _react2.default.createElement(
                _react.Fragment,
                null,
                _react2.default.Children.map(children, function (raInputComponent) {
    ...
    (0, _createClass3.default)(FormTab, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = (0, _objectWithoutProperties3.default)(_props, ['children', 'context', 'hidden']);

            return context === 'header' ? this.renderHeader(rest) : hidden ? this.renderHiddenContent({ children: children }) : this.renderContent((0, _extends3.default)({ children: children }, rest));
        }
    }]);
    return FormTab;
}(_react.Component);
